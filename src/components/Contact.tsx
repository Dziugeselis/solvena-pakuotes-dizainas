        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <Card className="border-0 shadow-soft bg-card/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-2xl text-foreground">UAB „Solvena"</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+37068781366" className="text-brand-gold hover:underline">
                      +370 687 81366
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">El. paštas</p>
                    <a href="mailto:info@solvena.lt" className="text-brand-gold hover:underline">
                      info@solvena.lt
                    </a>
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-soft bg-card/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-xl text-foreground">Įmonės duomenys</CardTitle>
              </CardHeader>
            ...
            <Card className="border-0 shadow-soft bg-card/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-xl text-foreground">Direktorius</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-brand-gold/20 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Saulius Kaluina</p>
                    <p className="text-muted-foreground">Kalbos: lietuvių, anglų</p>
                    <a href="mailto:saulius@solvena.lt" className="text-brand-gold hover:underline">
                      saulius@solvena.lt
                    </a>
                  </div>
                </div>
              ...
              <form className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" placeholder="jusu@email.lt" required />
                  </div>
                  <div className="space-y-2">
